...
public class Cuenta {
    ...
    private double obtenerdebe(int idcuenta) {
   double debe = 0;
   int cuenta;
    cuenta=idcuenta;
       try{
...
private double obtenerhaber(int idcuenta) {
   double haber = 0;
   int cuenta ;
    cuenta=idcuenta;
       try{
...
private double obtenersaldo(int idcuenta) {
   double debe = 0;
   double haber =0;
   double saldo =0;
   int cuenta ;
